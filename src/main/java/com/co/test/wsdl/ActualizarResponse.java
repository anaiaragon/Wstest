 ...
 *         &lt;element name="error" type="{http://integracion.coopeuch.cl/wstest/}Excepcion" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
public class ActualizarResponse {
     ...
     *     
     */
    public void setError(Excepcion value) {
        this.error = value;
    }
